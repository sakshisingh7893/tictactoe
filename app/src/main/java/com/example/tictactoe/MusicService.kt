...
class MusicService : Service(), MediaPlayer.OnErrorListener {
    ...
    override fun onCreate() {
        super.onCreate()
        mPlayer = MediaPlayer.create(this, com.example.tictactoe.R.raw.gaana) //replace with your song name!
    ...
    fun startMusic() {
        mPlayer = MediaPlayer.create(this, com.example.tictactoe.R.raw.gaana)
        mPlayer!!.setOnErrorListener(this)
        if (mPlayer != null) {
            mPlayer!!.isLooping = true
            mPlayer!!.setVolume(50f, 50f)
